...
train.py — cap3_acc70
=====================================
Trains a BoxedCounter to track a linear (non-wrapping) count in [0, 2].
Uses curriculum training: cap1 → cap2 → cap3.
Saves weights.pt when cap3 accuracy first reaches 70% for 2 consecutive epochs.

Usage (from repo root):
    python demos/wynns_world/models/pretrained/cap3_acc70/train.py
"""
