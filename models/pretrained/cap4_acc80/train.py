...
train.py — cap4_acc80
=====================================
Trains a BoxedCounter to track a linear (non-wrapping) count in [0, 3].
Uses curriculum training: cap1 → cap2 → cap3 → cap4.
Saves weights.pt when cap4 accuracy first reaches 80% for 2 consecutive epochs.

Usage (from repo root):
    python demos/wynns_world/models/pretrained/cap4_acc80/train.py
"""
